        ...
        : wxFrame(parent, id, title, pos, size, style)
{
    ...
    wxToolBar* play_toolbar = new wxToolBar(this, wxID_ANY, wxDefaultPosition, wxDefaultSize,
                                   wxTB_FLAT | wxTB_NODIVIDER);
    play_toolbar->SetToolBitmapSize(wxSize(16,16));

    play_toolbar->AddTool(101, wxT("stop"), wxBitmap( stop_xpm));
    play_toolbar->AddTool(101, wxT("pause"), wxBitmap( pause_xpm));
    play_toolbar->AddTool(101, wxT("step"), wxBitmap( step_xpm));
    play_toolbar->AddTool(101, wxT("play"), wxBitmap( play_xpm));
    play_toolbar->Realize();
    ...
    m_mgr.AddPane(play_toolbar, wxAuiPaneInfo().
                  Name(wxT("play_toolbar")).Caption(wxT("Toolbar 2")).
